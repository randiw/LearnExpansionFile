...
public abstract class APEZProvider extends ContentProvider {
    ...
    private static final String TAG = APEZProvider.class.getSimpleName();
...
//                mainFileVersion = patchFileVersion = appVersionCode;
                ...
                mainFileVersion = getMainVersion();
                patchFileVersion = getPatchVersion();
            }
            try {
                if (null == resourceFiles) {
                    Log.d(TAG, "resourceFiles null mainFileVersion " + mainFileVersion + " patchFileVersion " + patchFileVersion);
